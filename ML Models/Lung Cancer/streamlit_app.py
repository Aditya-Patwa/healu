...
if st.button('Detection Result'):
    ...
    model = joblib.load(os.path.join(DIR, 'lung_cancer_predictor_model.pkl'))
    prediction = model.predict(features)
    
    if prediction[0] == 1:
        st.error("This Person has a very high chance of having lung cancer. Please see a Doctor!")
    else:
        st.success("This probability of this person having lung cancer is very low.")
